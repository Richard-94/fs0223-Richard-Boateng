...
var User = /** @class */ (function () {
    ...
    User.prototype.totalCalls = function (duration) {
        ...
        if (this.recharge <= 0) {
            ...
            var callTime_1 = call.date.toLocaleTimeString();
            console.log("Call ID:", call.id, "| Call Date:", callDate, "| Call Time:", callTime_1);
...
var callTime = myDate.toLocaleTimeString([], options);
time.textContent = callTime;
...
var numbers = document.querySelectorAll(".my-numbers");
numbers.forEach(function (number) {
    number.addEventListener("click", respond);
});
